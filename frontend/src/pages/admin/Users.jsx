...
const UserManagement = () => {
  ...
  const mockUsers = [
    { id: 1, firstName: 'John', lastName: 'Doe', email: 'john.doe@company.com', role: 'employee', department: 'Engineering', status: 'active', lastLogin: '2024-01-15 09:00 AM' },
    { id: 2, firstName: 'Sarah', lastName: 'Smith', email: 'sarah.smith@company.com', role: 'hr_manager', department: 'HR', status: 'active', lastLogin: '2024-01-15 08:45 AM' },
    { id: 3, firstName: 'Mike', lastName: 'Johnson', email: 'mike.j@company.com', role: 'employee', department: 'Sales', status: 'active', lastLogin: '2024-01-14 05:30 PM' },
    { id: 4, firstName: 'Emily', lastName: 'Davis', email: 'emily.d@company.com', role: 'employee', department: 'HR', status: 'active', lastLogin: '2024-01-15 09:15 AM' },
    { id: 5, firstName: 'David', lastName: 'Wilson', email: 'david.w@company.com', role: 'super_admin', department: 'Administration', status: 'active', lastLogin: '2024-01-15 08:00 AM' },
    { id: 6, firstName: 'Lisa', lastName: 'Brown', email: 'lisa.b@company.com', role: 'employee', department: 'Engineering', status: 'inactive', lastLogin: '2024-01-10 04:00 PM' },
  ]
