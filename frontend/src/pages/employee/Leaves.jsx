...
const Leaves = () => {
  ...
  const mockLeaves = [
    { id: 1, type: 'Sick Leave', startDate: '2026-01-20', endDate: '2026-01-22', days: 3, reason: 'Feeling unwell', status: 'pending' },
    { id: 2, type: 'Casual Leave', startDate: '2026-01-15', endDate: '2026-01-15', days: 1, reason: 'Personal work', status: 'approved' },
    { id: 3, type: 'Paid Leave', startDate: '2026-01-10', endDate: '2026-01-12', days: 3, reason: 'Family vacation', status: 'approved' },
    { id: 4, type: 'Sick Leave', startDate: '2026-01-05', endDate: '2026-01-06', days: 2, reason: 'Medical appointment', status: 'rejected' },
  ]
