...
const Documents = () => {
  ...
  const mockDocuments = [
    { id: 1, name: 'Resume_2026.pdf', type: 'PDF', size: '245 KB', uploadedAt: '2026-01-15', category: 'Resume' },
    { id: 2, name: 'ID_Proof.pdf', type: 'PDF', size: '1.2 MB', uploadedAt: '2026-01-10', category: 'Identity' },
    { id: 3, name: 'Experience_Letter.pdf', type: 'PDF', size: '320 KB', uploadedAt: '2026-01-05', category: 'Experience' },
            ...
            >
              {selectedFile ? (
                <div className="flex flex-col items-center">
                  <FileText size={32} className="text-success-500 mb-2" />
                  <p className="text-sm font-medium text-gray-900">{selectedFile.name}</p>
                  <p className="text-xs text-gray-500 mt-1">{(selectedFile.size / 1024).toFixed(1)} KB</p>
                  <button
                    onClick={(e) => { e.stopPropagation(); setSelectedFile(null) }}
                    className="mt-2 text-xs text-danger-600 hover:text-danger-700 flex items-center gap-1"
                  >
                    <X size={12} /> Remove
                  </button>
                </div>
