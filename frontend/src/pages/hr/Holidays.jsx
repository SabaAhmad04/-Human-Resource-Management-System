...
const Holidays = () => {
  ...
  const mockHolidays = [
    { id: 1, name: 'New Year\'s Day', date: '2024-01-01', type: 'National Holiday' },
    { id: 2, name: 'Republic Day', date: '2024-01-26', type: 'National Holiday' },
    { id: 3, name: 'Holi', date: '2024-03-25', type: 'Festival' },
    { id: 4, name: 'Good Friday', date: '2024-03-29', type: 'Optional Holiday' },
    { id: 5, name: 'Independence Day', date: '2024-08-15', type: 'National Holiday' },
    { id: 6, name: 'Gandhi Jayanti', date: '2024-10-02', type: 'National Holiday' },
    { id: 7, name: 'Diwali', date: '2024-11-01', type: 'Festival' },
    { id: 8, name: 'Christmas', date: '2024-12-25', type: 'Optional Holiday' },
  ]
  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Holiday Calendar 2024">
