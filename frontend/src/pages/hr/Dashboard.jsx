...
const HRDashboard = () => {
  ...
  const announcements = [
    { id: 1, title: 'Company Annual Meeting', date: '2024-01-20', priority: 'high' },
    { id: 2, title: 'New Policy Updates', date: '2024-01-18', priority: 'medium' },
    { id: 3, title: 'Team Building Event', date: '2024-01-25', priority: 'low' },
  ]
