...
const HRPayroll = () => {
  ...
  const [payrolls, setPayrolls] = useState([
    { id: 1, employee: 'John Doe', department: 'Engineering', month: 'January 2026', gross: 7500, deductions: 2500, net: 5000, status: 'processed' },
    { id: 2, employee: 'Sarah Smith', department: 'Marketing', month: 'January 2026', gross: 6500, deductions: 2000, net: 4500, status: 'processed' },
    { id: 3, employee: 'Mike Johnson', department: 'Sales', month: 'January 2026', gross: 5500, deductions: 1500, net: 4000, status: 'pending' },
    { id: 4, employee: 'Emily Davis', department: 'HR', month: 'January 2026', gross: 6000, deductions: 1800, net: 4200, status: 'pending' },
    { id: 5, employee: 'David Wilson', department: 'Finance', month: 'January 2026', gross: 7000, deductions: 2200, net: 4800, status: 'paid' },
  ])
  ...
  const handleGeneratePayroll = () => {
    toast.success('Payroll generated for all pending employees')
  }
