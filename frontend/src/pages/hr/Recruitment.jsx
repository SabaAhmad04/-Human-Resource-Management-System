...
const Recruitment = () => {
  ...
  const mockInterviews = [
    { id: 1, candidate: 'Alex Johnson', position: 'Senior React Developer', date: '2024-01-20', time: '10:00 AM', round: 'Technical', interviewer: 'John Doe', status: 'scheduled' },
    { id: 2, candidate: 'Maria Garcia', position: 'Marketing Manager', date: '2024-01-21', time: '2:00 PM', round: 'HR', interviewer: 'Sarah Smith', status: 'scheduled' },
    { id: 3, candidate: 'James Wilson', position: 'Sales Executive', date: '2024-01-18', time: '11:00 AM', round: 'Final', interviewer: 'Mike Johnson', status: 'completed' },
  ]
