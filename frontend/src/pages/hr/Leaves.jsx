...
const HRLeaves = () => {
  ...
  const [leaves, setLeaves] = useState([
    { id: 1, employee: 'John Doe', department: 'Engineering', type: 'Sick Leave', startDate: '2026-01-20', endDate: '2026-01-22', days: 3, reason: 'Feeling unwell', status: 'pending' },
    { id: 2, employee: 'Sarah Smith', department: 'Marketing', type: 'Casual Leave', startDate: '2026-01-15', endDate: '2026-01-15', days: 1, reason: 'Personal work', status: 'pending' },
    { id: 3, employee: 'Mike Johnson', department: 'Sales', type: 'Paid Leave', startDate: '2026-01-10', endDate: '2026-01-12', days: 3, reason: 'Family vacation', status: 'approved' },
    { id: 4, employee: 'Emily Davis', department: 'HR', type: 'Sick Leave', startDate: '2026-01-05', endDate: '2026-01-06', days: 2, reason: 'Medical appointment', status: 'rejected' },
    { id: 5, employee: 'David Wilson', department: 'Finance', type: 'Casual Leave', startDate: '2026-01-25', endDate: '2026-01-26', days: 2, reason: 'Personal commitment', status: 'pending' },
  ])
